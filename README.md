...
pytest tests/lexer/ -v      # 93 tests
pytest tests/parser/ -v     # 87 tests
pytest tests/semantic/ -v   # 47 tests
pytest tests/codegen/ -v    # 68 tests
...
### 🔜 Phase 5: Standard Library (Planned)
